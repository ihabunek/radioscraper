...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchWith = function searchWith(params) {
	...
	(0, _jquery2.default)(document).ready(function () {
	    (0, _jquery2.default)('a[data-artist]').click(function (e) {
	        e.preventDefault();
	        searchWith({ "artist": e.target.dataset.artist });
	    });
	
	    (0, _jquery2.default)('a[data-title]').click(function (e) {
	        e.preventDefault();
	    ...
	    (0, _jquery2.default)('a[data-clear-field]').click(function (e) {
	        e.preventDefault();
	    ...
	    var startDatepicker = (0, _jquery2.default)('.time-span > input[name=start]').datepicker(options);
	
	    var endDatepicker = (0, _jquery2.default)('.time-span > input[name=end]').datepicker(options);
	
	    var getDate = function getDate(element) {
	        try {
	            return _jquery2.default.datepicker.parseDate(dateFormat, element.value);
	        } catch (error) {
	            return null;
	        }
	    };
